...
The purpose of this project is to analyze the Million Song Database to predict "Hot" artists and songs based 
on the attributes such as familiarity, artist location, loudness, terms used, etc.  The analysis was done 
using R software on a 10,000 track subset of the data and our model was able to predict "Hot" songs with 
~80% accuracy. 
